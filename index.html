...
<a href="https://www.cursors-4u.com/cursor/2011/11/26/shiny-gold-star.html" target="_blank" title="Shiny Gold Star">
  ...
  <header id="top" class="position-sticky top-0 start-0" style="z-index:10;">
    ...
    <a href="#portfolio" style="font-family: Arial; font-size: 24px; color: black; text-decoration: none; margin-right: 20px;">Portofolio</a>
          ...
          <div class="col-md-3">
            <div class="d-flex align-items-center gap-4">
              ...
              <p class="text-light-emphasis justify-content-center m-0 ls-4">
                final assignment 3rd semester <br> majoring in Computer Science
              </p>
            </div>
          </div>    
        </div>
        ...
        <div class="col-lg-3">
          <div class="d-flex gap-4 align-items-start">
            ...
            <div class="text-md-start">
              ...
              <p class="postf">
                intuitive and aesthethic interface designer
              </p>
            </div>
          </div>
        </div>
